...
public class EventStoreFactory<T> {
	...
	public static <T> EventStoreFactory<T> create() {
	...
	public EventStoreFactory<T> setDeserializer(Function<byte[], T> deserializer) {
		config.setDeserializer(deserializer);
		return this;
	}

	public EventStoreFactory<T> setSerializer(Function<T, byte[]> serializer) {
