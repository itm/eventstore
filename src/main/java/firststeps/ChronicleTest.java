...
public class ChronicleTest {
    public static final String CHRONICLE_PREFIX = "/Volumes/BigBrain/Arbeit/ITM/testbed-event-store/chronicle-test/chronicles/";
    ...
    public static void main(String[] args) {
        ...
        for (TestConfiguration config : configurations) {
            try {
                ...
                writer.append(config.getDataSize() + "\t" + config.getIterations() + "\t" + config.getSleepTimeInMs() + "\t" + totalWriteTime + "\t" + totalSequentialReadTime + "\t" + totalRandomReadTime + "\n");
                chronicle.close();
