...
public class EventStoreSerializationHelperTest extends TestCase {
    ...
    private EventStoreSerializationHelper buildSerializationHelper() throws Exception {
        ...
        serializers.put(Byte.class, new Function<Byte, byte[]>() {
            @Nullable
            @Override
        ...
        String basePath = System.getProperty("java.io.tmpdir") + "/EventStoreSerializationHelper";
    ...
    public void testSerializationHelperWorksAfterRestart() throws Exception {
        ...
        for (int i = 0; i < 10000; i++) {
            EventStoreSerializationHelper secondHelper = buildSerializationHelper();
